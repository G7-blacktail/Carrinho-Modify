...
@Component({
  selector: 'app-pedido-publico-list',
...
export class PedidoListComponent extends AbstractComponent implements OnInit {
  ...
  private doList(): void {
    this.storeQueryData('PedidoListComponent_QueryData', '', this.pageNumber, this.pageSize);
    const observable = this.pedidoService.list('', 'my', this.pageNumber - 1, this.pageSize);
