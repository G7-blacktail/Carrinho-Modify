...
@Component({
  selector: 'app-pre-cadastro-pf-publico-edit',
  templateUrl: './pre-cadastro-pf-edit.component.html',
  styleUrls: ['./pre-cadastro-pf-edit.component.css']
})
export class PreCadastroPfEditComponent extends AbstractPreCadastroEditComponent {
  ...
  constructor(logger: Logger, localStorageService: LocalStorageService, modalService: NgbModal,
    ...
    super(logger, localStorageService, modalService, fb, route, router, preCadastroService, ufService, municipioService, voucherService, 1);
  }
